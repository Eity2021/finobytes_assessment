...
const seedUsers = async () => {
  const users = [
    ...
    { id: 2, name: "Mohan Merchant", email: "merchant@example.com", role: "merchant", password: "merchant123" },
    { id: 3, name: "Mina Member", email: "member@example.com", role: "member", password: "member123" },
  ];
